...
namespace Hyprsoft.Dns.Monitor.Providers
{
    public class HyprsoftPublicIpProvider : PublicIpProvider, IDisposable
    {
        ...
        public HyprsoftPublicIpProvider(ILogger<HyprsoftPublicIpProvider> logger, PublicIpProviderApiCredentials credentials, HttpClient httpClient) : base(logger, httpClient) => _client = new HyprsoftClient(credentials.ApiKey, credentials.ApiSecret);
